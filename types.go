// Package jsontest defines marker types and helper types for JSON assertion testing.
// This file contains types for controlling comparison behavior and order-insensitive testing.
package jsontest
