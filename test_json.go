// Package jsontest provides the core TestJSON function and path classification logic.
// This file contains the main public API for JSON assertion testing with path-based validation.
package jsontest
...
// pathKind constants define different types of JSON path expressions for classification and handling.
const (
