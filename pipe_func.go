// Package jsontest provides pipe function infrastructure for JSON assertion testing.
// Pipe functions allow transformation and validation of JSON values during test processing.
package jsontest
...
func GetRegisteredPipeFunc(name string) (pf PipeFunc) {
	if registeredPipeFunc == nil {
		panic("No jsontest pipe funcs have been registered.\nDid you forget to import github.com/mikeschinkel/go-jsontest/pipefuncs for side effects (by prefixing it with '_')?")
	}
