// Package jsontest provides a comprehensive JSON testing framework with declarative assertions and pipe functions.
// It supports path-based JSON validation, array handling, pipe transformations, and sophisticated comparison logic.
package jsontest
